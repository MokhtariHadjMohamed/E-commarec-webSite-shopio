...
<head>
    ...
    <link rel="stylesheet" href="Css/coustomers.css">
    <!-- Google font -->
            ...
            <div class="container">
                ...
                <div class="table">
                    <table border="1" cellpadding='0'>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM `client`";
                                ...
                                $sql = "SELECT * FROM `client` where NameClient like '%$search_input%'";
                            }
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        ...
                        <td><a href="delete.php?idClient='.$idClient.'&tabel=client" class="btnDelete">Delete</a></td>
                        </tr>';
                    }
                    ?>
                        </tbody>
